...
const HomeAbout = () => {
  return (
    <>
      <div className="mt-10 md:px-10 px-4 max-w-screen-2xl mx-auto">
      ...
      <div className="rounded-xl md:p-9 px-4 shadow">
        <div className="flex flex-col px-2 md:flex-row-reverse justify-between items-center">
          <div>
            <img src="https://cdn.paleo.gg/games/jwe2/images/dino/chungkingosaurus.png" alt="Image" className="lg:h-[400px] h-[250px]" />
          </div>
          <div className="md:w-3/5">
          <p className="-mt-4 text-justify text-slate-200 font-body text-sm md:text-lg bg-gradient-to-t from-slate-800 p-4 rounded-br-[60px]">
