    ...
    <nav className="gradient md:px-12 p-3 pb-6 max-w-screen-2xl mx-auto text-white md:static fixed top-0 right-0 left-0">
      <div className="text-lg container mx-auto flex justify-between items-center font-medium">
        ...
        <Link to="/Home" className="text-blue-500 font-bold">
          ...
          <ul className="md:flex space-x-12 mobile:hidden xs:hidden xxs:hidden xsm:hidden">
        ...
        <div className="text-heading space-x-12 hidden md:flex items-center">
            <button className="bg-primary disabled py-2 px-4 transition-all duration-300 rounded hover:bg-gray-500">Daftar</button>
        </div>
