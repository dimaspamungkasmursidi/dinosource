...
const Footer = () => {
    return ( 
        <>
<div className="relative mt-16 bg-secondary gradientFooter rounded-tl-[40px] index">
      <div className="px-4 pt-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          ...
          <div className="flex items-center mt-4 sm:mt-0"> {/* space-x-4 */}
            ...
            <Link to="https://www.instagram.com/dmspamungkass/" className="flex items-center transition-colors duration-300 text-pink-500 hover:text-teal-accent-400">
            <a
              href="https://www.instagram.com/dmspamungkass/"
              className="transition-colors duration-300 text-pink-500 hover:text-teal-accent-400"
            >
            ...
            <p className="text-sm font-semibold bg-gradient-to-r from-purple-900 to-pink-600 bg-clip-text text-transparent">@dmspamungkass</p>
            </Link>
          </div>
        </div>
      </div>
